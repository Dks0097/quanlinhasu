            ...
            <div class="card-footer">
              <div class="row">
                <div class="col-6 d-grid">
                  <a href="{{ Auth::user()->role->slug === 'super-admin' ? route('attendance.index') : (Auth::user()->role->slug === 'administrator' ? route('admin.attendance.index', $attendance->id) : route('moderator.attendance.index', $attendance->id) ) }}" class="btn btn-outline-secondary" >

            ...
            <div class="card-footer">
              <div class="row g-3">
                <div class="col-6 d-grid">
                  <a href="{{ Auth::user()->role->slug === 'super-admin' ? route('department.index') : (Auth::user()->role->slug === 'administrator' ? route('admin.department.index', $department->id) : route('hr.department.index', $department->id) ) }}" class="btn btn-outline-secondary">
